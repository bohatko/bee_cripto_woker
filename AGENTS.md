...
| [`doc/01_TECHNICAL_SPECIFICATION.md`](doc/01_TECHNICAL_SPECIFICATION.md) | **Полное техническое задание**: описание SaaS, бизнес-модель, триал 7 дней, тарифы Lite (70/700 USDT) и Pro (200/2000 USDT) без процента с прибыли, политика неоплаты (Вариант А), архитектура системы. |
...
* **Хостинг воркера**: **Railway** со статическим исходящим IP-шлюзом (Static Egress IPs EU West HA: `208.77.244.240`, `152.55.185.189`, `152.55.185.190`).
...
3. **Статический IP Railway (`208.77.244.240`, `152.55.185.189`, `152.55.185.190`)**:
 * Всегда напоминать пользователю указывать **все три** IP в белом списке на бирже.
