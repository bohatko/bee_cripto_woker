...
8. **Подписка Lite / Pro** (миграция [`migrations/2026-09-25_subscription_plans.sql`](migrations/2026-09-25_subscription_plans.sql)):
   * Процент с прибыли снят. Партнёру начисляется $50 один раз, если приглашённый оплатил подписку не ниже Лайт на месяц (`migrations/2026-09-25_referral_flat_bonus.sql`). Миграция `2026-09-23_referral_program.sql` больше не действует.
