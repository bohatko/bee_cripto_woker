...
-- ==============================================================================
-- ТАБЛИЦА 12: signal_strategies (Каталог стратегий сигналов)
-- ==============================================================================
...
-- ==============================================================================
-- ТАБЛИЦА 13: user_signal_settings (Настройки сигналов пользователя)
-- ==============================================================================
...
-- ==============================================================================
-- ТАБЛИЦА 14: signal_events (Глобальный лог сработавших сигналов)
-- ==============================================================================
...
-- ==============================================================================
-- ТАБЛИЦА 15: signal_positions (Мастер paper и реальные клиентские позиции)
-- ==============================================================================
...
BEGIN
    ...
    CREATE TRIGGER trg_signal_strategies_upd BEFORE UPDATE ON public.signal_strategies FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();
